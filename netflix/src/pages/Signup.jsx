                    ...
                    <h1 className='font-bold text-3xl '> Sign up</h1>
                     <form onSubmit={handleSubmit} className='w-full flex flex-col py-4' >
                        ...
                        onChange={(e) => setEmail(e.target.value)}
                         type="email" className='border-white p-3 my-3 bg-gray-600 rounded' placeholder='Email' autoComplete='email' />
                        <input
                        onChange={(e) => setPassword(e.target.value)}
                        type="password"className='border-white p-3 my-3 bg-gray-600 rounded' placeholder='Password' autoComplete='current-password' />
